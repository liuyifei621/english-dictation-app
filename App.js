...
export default function App() {
  ...
  const start = () => {
    ...
    setSessionEntries(list); setIndex(0); setRunning(true); setAnswerVisible(false); activeRef.current = true;
